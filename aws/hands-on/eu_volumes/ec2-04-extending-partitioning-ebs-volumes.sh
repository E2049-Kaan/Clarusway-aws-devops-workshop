<<<<<<< HEAD:aws/hands-on/eu_volumes/ec2-04-extending-partitioning-ebs-volumes.md
...
# NOTE: You can use "sudo mount -a" to mount volumes and partitions after editing fstab file without rebooting.
>>>>>>> 363c38304d2391cba2a5b9e76b7975789d663ea9:aws/hands-on/eu_volumes/ec2-04-extending-partitioning-ebs-volumes.sh
